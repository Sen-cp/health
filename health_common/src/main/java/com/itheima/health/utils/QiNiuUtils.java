...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "xf5sZGvji31XFnGOSjkWKSW9FFaOatAUQ5d9A4DQ";
    private static final String SECRETKEY = "s7P6vKGfdK2V7Ubu93_W5U9NoNCl7UHkcC0TtcoY";
    private static final String BUCKET = "szit";
    public static final String DOMAIN= "http://qiqk1xfnh.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
//        uploadFile("D:\\Snipaste_2020-08-11_09-54-57.png","dd2.jpg");
//        removeFiles("Snipaste_2020-08-11_09-54-57.png");
//        listFile();
    }
